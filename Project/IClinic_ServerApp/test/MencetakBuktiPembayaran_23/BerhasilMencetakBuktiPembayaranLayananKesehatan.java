 ...
 *
 */
public class BerhasilMencetakBuktiPembayaranLayananKesehatan implements Remote {

    Bag_PembayaranServiceServer bag_PembayaranServiceServer;
    TableModelLog tableModelLog = new TableModelLog();

    public BerhasilMencetakBuktiPembayaranLayananKesehatan() throws RemoteException {
    ...
    public void testMencetakBuktiPembayaranLayananKesehatan() throws Exception {
        ...
        List<Pembayaran> instance = bag_PembayaranServiceServer.getPembayaranPrintLk(Id_Pembayaran);
        Pembayaran pembayaran = new Pembayaran();

        Pembayaran expResult = new Pembayaran();
        expResult.setID_PEMBAYARAN("BYR0002");
        expResult.setNAMA_PASIEN("AGUS");
        expResult.setTOTAL_USG(100000);
        expResult.setTOTAL_LAB(0);
        expResult.setTOTAL_RESEP(0);
        expResult.setTOTAL_REKAM(0);
        expResult.setTOTAL_KECANTIKAN(0);
        expResult.setTOTAL_HARGA(100000);
