...
public class DokterBerhasilMengisiResepLebihDari1Obat implements Remote{
    DokterServiceServer dokterServiceServer;
    
    public DokterBerhasilMengisiResepLebihDari1Obat() throws RemoteException{
    ...
    @Test
    public void testInsertDetailResep1() throws Exception {
    ...
    @Test
    public void testInsertDetailResep2() throws Exception {
        System.out.println("insertDetailResep");
        
        Obat_detailResep instance = new Obat_detailResep();
        instance.setId_Resep("RSP0001");
        instance.setNo_Detail_Resep("DR0002");
        instance.setId_Obat("OBT0002");
        instance.setTakaran("1 kali sehari");
        instance.setJumlah(5);
        instance.setPemakaian("DIMINUM");
        instance.setKeterangan("");
        
        Obat_detailResep expResult = new Obat_detailResep();
        expResult.setId_Resep("RSP0001");
        expResult.setNo_Detail_Resep("DR0002");
        expResult.setId_Obat("OBT0002");
        expResult.setTakaran("1 kali sehari");
        expResult.setJumlah(5);
        expResult.setPemakaian("DIMINUM");
        expResult.setKeterangan("");
